...
public class PatchSettings implements Setting {
	...
	private BooleanProperty patchListOrder = new SimpleBooleanProperty();
	...
	private void patchEvoListOrder(RandomizationContext context) {
		...
		List<Digimon> digimondata = new ArrayList<>(context.getGlobalKeepData().getDigimonData());
		var digimmonNames = context.getLanguageKeep().getDigimonNames();
		digimondata.sort(Comparator.comparing(Digimon::getLevel).thenComparing(a -> digimmonNames.getStringById(a.getId())));
	...
	private void addBlackAgumon(RandomizationContext context) {
		...
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.HIGHEST, Type.MP_DIV10, 0));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.LESS_THAN, Type.WEIGHT, 12));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 3, Operator.AND, Comperator.EQUALS, Type.DIGIMON,
				DigimonList.KOROMON));
		...
		setEvolveTo(keep, ownId, DigimonList.BLACK_WARGROWLMON, DigimonList.GREYMON, DigimonList.SEADRAMON,
				DigimonList.GROWLMON, DigimonList.WOODMON);
	...
	private void addBlackGabumon(RandomizationContext context) {
		...
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.HIGHEST, Type.MP_DIV10, 0));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.GREATER_THAN, Type.WEIGHT, 14));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 3, Operator.AND, Comperator.EQUALS, Type.DIGIMON,
				DigimonList.TSUNOMON));

		keep.getEvoRequirements().get(ownId - 1).setRequirements(requirements);

		// Evo Paths
		setEvolveFrom(keep, ownId, DigimonList.TSUNOMON);
		setEvolveTo(keep, ownId, DigimonList.BLACKGARURUMON, DigimonList.GARURUMON, DigimonList.GAOGAMON,
				DigimonList.VEEDRAMON, DigimonList.LEOMON);
	...
	private void addTsukaimon(RandomizationContext context) {
		...
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.GREATER_THAN, Type.WEIGHT, 15));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 3, Operator.AND, Comperator.EQUALS, Type.DIGIMON,
				DigimonList.TOKOMON));
		...
		setEvolveTo(keep, ownId, DigimonList.DEVIMON, DigimonList.BLACKGATOMON, DigimonList.OGREMON,
				DigimonList.AIRDRAMON, DigimonList.KABUTERIMON);
	...
	private void addPsychemon(RandomizationContext context) {
		...
		requirements.add(new Requirement(SuperGroup.QUOTA, (byte) 0, Operator.QUOTA, Comperator.QUOTA, Type.QUOTA, 2));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.HIGHEST, Type.HP_DIV10, 0));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.GREATER_THAN, Type.WEIGHT, 13));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 3, Operator.AND, Comperator.EQUALS, Type.DIGIMON,
				DigimonList.WANYAMON));

		keep.getEvoRequirements().get(ownId - 1).setRequirements(requirements);

		// Evo Paths
		setEvolveFrom(keep, ownId, DigimonList.WANYAMON);
		setEvolveTo(keep, ownId, DigimonList.GURURUMON, DigimonList.KYUBIMON, DigimonList.BAKEMON, DigimonList.TOGEMON,
				DigimonList.KUWAGAMON);

		setDescriptionString(context, ownId,
				"Focus on HP and high weight.\nEvolves from Wanyamon.\n\nDon't trust this false prophet.");
	}
	...
	private void addSnowAgumon(RandomizationContext context) {
		...
		requirements.add(new Requirement(SuperGroup.QUOTA, (byte) 0, Operator.QUOTA, Comperator.QUOTA, Type.QUOTA, 2));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.HIGHEST, Type.DEFENSE, 0));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.LESS_THAN, Type.WEIGHT, 12));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 3, Operator.AND, Comperator.EQUALS, Type.DIGIMON,
				DigimonList.GIGIMON));
		...
		setEvolveTo(keep, ownId, DigimonList.ICEDEVIMON, DigimonList.IKKAKUMON, DigimonList.GURURUMON,
				DigimonList.EXVEEMON, DigimonList.CENTARUMON);
	...
	private void addSolarmon(RandomizationContext context) {
		...
		requirements.add(new Requirement(SuperGroup.QUOTA, (byte) 0, Operator.QUOTA, Comperator.QUOTA, Type.QUOTA, 2));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.HIGHEST, Type.OFFENSE, 0));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.GREATER_THAN, Type.WEIGHT, 15));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 3, Operator.AND, Comperator.EQUALS, Type.DIGIMON,
				DigimonList.MOTIMON));
		...
		setEvolveTo(keep, ownId, DigimonList.GUARDROMON, DigimonList.GROWLMON_ORANGE, DigimonList.BIRDRAMON,
				DigimonList.VEGIEMON, DigimonList.GEREMON);
	...
	private void addBlackGarurumon(RandomizationContext context) {
		...
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.HP, 1000));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.SPEED, 85));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.DEFENSE, 60));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.LESS_THAN, Type.WEIGHT, 25));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 3, Operator.AND, Comperator.LESS_THAN, Type.CARE, 4));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 4, Operator.AND, Comperator.GREATER_THAN, Type.HAPPINESS, 70));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 5, Operator.AND, Comperator.GREATER_THAN, Type.TECHS, 25));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 6, Operator.AND, Comperator.GREATER_THAN,
				Type.DECODE_LEVEL, 10));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 7, Operator.AND, Comperator.EQUALS, Type.DIGIMON,
				DigimonList.BLACKGABUMON));

		keep.getEvoRequirements().get(ownId - 1).setRequirements(requirements);

		// Evo Paths
		setEvolveFrom(keep, ownId, DigimonList.BLACKGABUMON, DigimonList.GABUMON, DigimonList.SALAMON,
				DigimonList.RENAMON);
		setEvolveTo(keep, ownId, DigimonList.BLACKWEREGARURUMON, DigimonList.BLUEMERAMON, DigimonList.WARUMONZAEMON);

		setDescriptionString(context, ownId,
				"Requires HP, DEF and SPD.\nDon't get too heavy. Being happy helps.\nEvolves easier from BlackGabumon.");
	}
	...
	private void addGururumon(RandomizationContext context) {
		...
		requirements.add(new Requirement(SuperGroup.QUOTA, (byte) 0, Operator.QUOTA, Comperator.QUOTA, Type.QUOTA, 3));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.HP, 900));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.OFFENSE, 65));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.DEFENSE, 110));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.SPEED, 65));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.LESS_THAN, Type.WEIGHT, 25));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 3, Operator.AND, Comperator.GREATER_THAN, Type.CARE, 2));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 4, Operator.AND, Comperator.LESS_THAN, Type.DISCIPLINE, 60));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 5, Operator.AND, Comperator.GREATER_THAN, Type.TECHS, 20));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 6, Operator.AND, Comperator.GREATER_THAN,
				Type.DECODE_LEVEL, 9));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 7, Operator.AND, Comperator.EQUALS, Type.DIGIMON,
				DigimonList.PSYCHEMON));

		keep.getEvoRequirements().get(ownId - 1).setRequirements(requirements);

		// Evo Paths
		setEvolveFrom(keep, ownId, DigimonList.PSYCHEMON, DigimonList.SNOWAGUMON, DigimonList.VEEMON,
				DigimonList.GAOMON);
		setEvolveTo(keep, ownId, DigimonList.WEREGARURUMON, DigimonList.ICELEOMON, DigimonList.TAOMON);

		setDescriptionString(context, ownId,
				"Requires high Defense. Don't get too heavy.\nDoesn't respect authority.\nEvolves easier from Psychemon.");
	}
	...
	private void addOrangeGrowlmon(RandomizationContext context) {
		...
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.DEFENSE, 110));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.SPEED, 150));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.GREATER_THAN, Type.WEIGHT, 28));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 3, Operator.AND, Comperator.LESS_THAN, Type.CARE, 4));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 4, Operator.AND, Comperator.GREATER_THAN, Type.BATTLES, 10));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 5, Operator.AND, Comperator.GREATER_THAN, Type.TECHS, 18));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 6, Operator.AND, Comperator.GREATER_THAN,
				Type.DECODE_LEVEL, 12));

		keep.getEvoRequirements().get(ownId - 1).setRequirements(requirements);

		// Evo Paths
		setEvolveFrom(keep, ownId, DigimonList.SOLARMON, DigimonList.GOBURIMON, DigimonList.LALAMON,
				DigimonList.PATAMON);
	...
	private void addBlackGrowlmon(RandomizationContext context) {
		...
		requirements.add(new Requirement(SuperGroup.QUOTA, (byte) 0, Operator.QUOTA, Comperator.QUOTA, Type.QUOTA, 3));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.HP, 800));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.OFFENSE, 110));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.DEFENSE, 110));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.GREATER_THAN, Type.WEIGHT, 28));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 3, Operator.AND, Comperator.LESS_THAN, Type.CARE, 5));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 4, Operator.AND, Comperator.GREATER_THAN, Type.BATTLES, 15));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 5, Operator.AND, Comperator.GREATER_THAN, Type.TECHS, 19));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 6, Operator.AND, Comperator.GREATER_THAN,
				Type.DECODE_LEVEL, 13));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 7, Operator.AND, Comperator.EQUALS, Type.DIGIMON,
				DigimonList.BLACKAGUMON));

		keep.getEvoRequirements().get(ownId - 1).setRequirements(requirements);

		// Evo Paths
		setEvolveFrom(keep, ownId, DigimonList.BLACKAGUMON, DigimonList.AGUMON, DigimonList.BETAMON,
				DigimonList.GUILMON);
		setEvolveTo(keep, ownId, DigimonList.BLACK_WARGROWLMON, DigimonList.METALGREYMON_VIRUS, DigimonList.MEGADRAMON);

		setDescriptionString(context, ownId,
				"Requires HP, Offense and Defense.\nLikes to fight.\nEvolves easier from BlackAgumon.");
	}
	...
	private void addIceDevimon(RandomizationContext context) {
		...
		requirements.add(new Requirement(SuperGroup.QUOTA, (byte) 0, Operator.QUOTA, Comperator.QUOTA, Type.QUOTA, 3));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.MP, 1150));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.SPEED, 85));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.BRAINS, 85));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.LESS_THAN, Type.WEIGHT, 30));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 3, Operator.AND, Comperator.GREATER_THAN, Type.CARE, 2));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 4, Operator.AND, Comperator.GREATER_THAN,
				Type.DISCIPLINE, 70));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 5, Operator.AND, Comperator.GREATER_THAN, Type.TECHS, 25));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 6, Operator.AND, Comperator.GREATER_THAN,
	...
	private void addGeremon(RandomizationContext context) {
		...
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 3, Operator.AND, Comperator.GREATER_THAN, Type.CARE, 2));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 4, Operator.AND, Comperator.LESS_THAN, Type.DISCIPLINE, 80));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 5, Operator.AND, Comperator.GREATER_THAN, Type.TECHS, 20));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 6, Operator.AND, Comperator.GREATER_THAN,
				Type.DECODE_LEVEL, 9));
	...
	private void addMetalGreymonVirus(RandomizationContext context) {
		...
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.HP, 2000));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.MP, 3000));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.GREATER_THAN, Type.OFFENSE, 350));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.GREATER_THAN, Type.DEFENSE, 200));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 3, Operator.AND, Comperator.GREATER_THAN, Type.BRAINS, 270));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 4, Operator.AND, Comperator.GREATER_THAN, Type.WEIGHT, 45));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 5, Operator.AND, Comperator.GREATER_THAN, Type.CARE, 3));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 6, Operator.AND, Comperator.GREATER_THAN,
				Type.DISCIPLINE, 75));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 6, Operator.AND, Comperator.GREATER_THAN, Type.BATTLES, 25));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 7, Operator.AND, Comperator.GREATER_THAN, Type.TECHS, 32));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 8, Operator.AND, Comperator.GREATER_THAN,
				Type.DECODE_LEVEL, 15));
	...
	private void addWarGrowlmonBlack(RandomizationContext context) {
		...
		requirements.add(new Requirement(SuperGroup.QUOTA, (byte) 0, Operator.QUOTA, Comperator.QUOTA, Type.QUOTA, 5));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.HP, 3000));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.GREATER_THAN, Type.DEFENSE, 360));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 3, Operator.AND, Comperator.GREATER_THAN, Type.SPEED, 230));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 3, Operator.AND, Comperator.GREATER_THAN, Type.BRAINS, 290));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 4, Operator.AND, Comperator.GREATER_THAN, Type.WEIGHT, 50));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 5, Operator.AND, Comperator.LESS_THAN, Type.CARE, 10));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 6, Operator.AND, Comperator.GREATER_THAN, Type.BATTLES, 30));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 7, Operator.AND, Comperator.GREATER_THAN, Type.TECHS, 28));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 8, Operator.AND, Comperator.GREATER_THAN,
				Type.DECODE_LEVEL, 13));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 9, Operator.AND, Comperator.EQUALS, Type.DIGIMON,
	...
	private void addWarGrowlmonOrange(RandomizationContext context) {
		...
		requirements.add(new Requirement(SuperGroup.QUOTA, (byte) 0, Operator.QUOTA, Comperator.QUOTA, Type.QUOTA, 5));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.HP, 2700));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.GREATER_THAN, Type.OFFENSE, 210));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.GREATER_THAN, Type.DEFENSE, 360));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 3, Operator.AND, Comperator.GREATER_THAN, Type.BRAINS, 370));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 4, Operator.AND, Comperator.GREATER_THAN, Type.WEIGHT, 45));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 5, Operator.AND, Comperator.LESS_THAN, Type.CARE, 10));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 6, Operator.AND, Comperator.GREATER_THAN, Type.BATTLES, 30));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 7, Operator.AND, Comperator.GREATER_THAN, Type.TECHS, 30));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 8, Operator.AND, Comperator.GREATER_THAN,
				Type.DECODE_LEVEL, 13));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 9, Operator.AND, Comperator.EQUALS, Type.DIGIMON,
				DigimonList.GROWLMON_ORANGE));
	...
	private void addBlackWereGarurumon(RandomizationContext context) {
		...
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.HP, 2000));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.MP, 2000));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.GREATER_THAN, Type.OFFENSE, 310));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 3, Operator.AND, Comperator.GREATER_THAN, Type.SPEED, 350));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 4, Operator.AND, Comperator.LESS_THAN, Type.WEIGHT, 40));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 5, Operator.AND, Comperator.LESS_THAN, Type.CARE, 15));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 6, Operator.AND, Comperator.GREATER_THAN, Type.HAPPINESS, 80));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 6, Operator.AND, Comperator.GREATER_THAN, Type.BATTLES, 25));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 7, Operator.AND, Comperator.GREATER_THAN, Type.TECHS, 35));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 8, Operator.AND, Comperator.GREATER_THAN,
				Type.DECODE_LEVEL, 14));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 9, Operator.AND, Comperator.EQUALS, Type.DIGIMON,
				DigimonList.BLACKGARURUMON));
	...
	private void addBlackWarGreymon(RandomizationContext context) {
		...
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.HP, 5500));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.GREATER_THAN, Type.OFFENSE, 650));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 3, Operator.AND, Comperator.GREATER_THAN, Type.DEFENSE, 550));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 4, Operator.AND, Comperator.GREATER_THAN, Type.BRAINS, 420));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 5, Operator.AND, Comperator.GREATER_THAN, Type.WEIGHT, 55));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 6, Operator.AND, Comperator.LESS_THAN, Type.CARE, 10));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 7, Operator.AND, Comperator.GREATER_THAN,
				Type.DISCIPLINE, 80));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 8, Operator.AND, Comperator.GREATER_THAN, Type.TECHS, 40));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 9, Operator.AND, Comperator.GREATER_THAN,
				Type.DECODE_LEVEL, 16));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 10, Operator.AND, Comperator.EQUALS, Type.DIGIMON,
	...
	private void addChaosDukemon(RandomizationContext context) {
		...
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.HP, 4000));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.GREATER_THAN, Type.MP, 3000));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 3, Operator.AND, Comperator.GREATER_THAN, Type.OFFENSE, 600));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 4, Operator.AND, Comperator.GREATER_THAN, Type.DEFENSE, 600));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 5, Operator.AND, Comperator.GREATER_THAN, Type.SPEED, 700));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 6, Operator.AND, Comperator.GREATER_THAN, Type.BRAINS, 500));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 7, Operator.AND, Comperator.GREATER_THAN, Type.WEIGHT, 60));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 8, Operator.AND, Comperator.LESS_THAN, Type.CARE, 10));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 9, Operator.AND, Comperator.GREATER_THAN, Type.HAPPINESS, 80));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 10, Operator.AND, Comperator.GREATER_THAN, Type.TECHS, 42));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 11, Operator.AND, Comperator.GREATER_THAN,
				Type.DECODE_LEVEL, 17));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 12, Operator.AND, Comperator.EQUALS, Type.DIGIMON,
				DigimonList.BLACK_WARGROWLMON));
		...
		setDescriptionString(context, ownId,
				"Requires high overall stats. Likes good food.\nEvolves easier from BlackWarGrowlmon.");
	}
	...
	private void addBlackMetalGarurumon(RandomizationContext context) {
		...
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 1, Operator.AND, Comperator.GREATER_THAN, Type.MP, 4500));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 2, Operator.AND, Comperator.GREATER_THAN, Type.OFFENSE, 500));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 3, Operator.AND, Comperator.GREATER_THAN, Type.DEFENSE, 700));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 4, Operator.AND, Comperator.GREATER_THAN, Type.SPEED, 700));
		requirements.add(
				new Requirement(SuperGroup.NORMAL, (byte) 5, Operator.AND, Comperator.GREATER_THAN, Type.BRAINS, 400));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 6, Operator.AND, Comperator.LESS_THAN, Type.WEIGHT, 50));
		requirements
				.add(new Requirement(SuperGroup.NORMAL, (byte) 7, Operator.AND, Comperator.LESS_THAN, Type.CARE, 15));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 8, Operator.AND, Comperator.GREATER_THAN, Type.HAPPINESS, 80));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 9, Operator.AND, Comperator.GREATER_THAN,
				Type.DISCIPLINE, 80));
		requirements.add(
				new Requirement(SuperGroup.BONUS, (byte) 10, Operator.AND, Comperator.GREATER_THAN, Type.TECHS, 44));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 11, Operator.AND, Comperator.GREATER_THAN,
				Type.DECODE_LEVEL, 17));
		requirements.add(new Requirement(SuperGroup.BONUS, (byte) 12, Operator.AND, Comperator.EQUALS, Type.DIGIMON,
				DigimonList.BLACKWEREGARURUMON));
	...
	private static void registerSprite(RandomizationContext context, short id, BufferedImage image) {
		Optional<GMIPKCAP> images = context.getFile("part0/arcv/Keep/GlobalKeepRes.res").map(AbstractKCAP.class::cast)
				.map(a -> (GMIPKCAP) a.get(8));
	...
	private static final int[] SPRITE_TABLES = { 0x4A4330, 0x4A4E00, 0x4A527C, 0x4A6E00, 0x4A9AB0, 0x4AA564, 0x4AAFBC,
			0x4AB678, 0x4ABD40, 0x4AC510, 0x4ACA90, 0x4AE12C, 0x4AE828, 0x4AF108, 0x4AFE08 };
	...
	private static void applyBaseData(RandomizationContext context, short self, short base, short evoListPos) {
		...
		if (modDigi.get().getAccessoryData().isEmpty())
			modDigi.ifPresent(b -> b
					.setAccessoryData(baseDigi.map(PartnerDigimon::getAccessoryData).orElse(Collections.emptyList())));
	}
	...
	public Map<String, Object> serialize() {
		...
		map.put("patchEvoListOrder", patchListOrder.get());
	...
	public void load(YamlMapping map) {
		...
		this.patchListOrder.set(Boolean.parseBoolean(map.string("patchListOrder")));
