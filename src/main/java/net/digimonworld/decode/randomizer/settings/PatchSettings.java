...
public class PatchSettings implements Setting {
    ...
    public TitledPane create(GlobalKeepData inputData, LanguageKeep languageKeep) {
        ...
        vbox.getChildren().addAll(JavaFXUtils.buildToggleSwitch("View Distance", Optional.of("Increases view distance, allowing to see Digimon from a further distance."), Optional.of(patchViewDistance)),
